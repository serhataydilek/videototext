...
Local-first web app for turning YouTube videos into timestamped transcripts.
...
- Generates a simple local transcript overview.
...
8. The result is saved in the browser with IndexedDB.
...
- A real AI summary is not included in the free local version; the app currently generates a simple local overview from the transcript.
